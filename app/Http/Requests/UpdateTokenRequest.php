...
class UpdateTokenRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pronounce_as' => ['sometimes', 'required', 'string', 'in:letters,word,custom'],
